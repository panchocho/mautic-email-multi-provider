...
final class RoundRobinModeStrategy extends AbstractModeStrategy implements ModeRoutingStrategyInterface
{
    ...
    public function rank(RoutingRequest $request, RoutingContext $context): array
    {
        ...
        $offset = abs(crc32($request->requestId)) % count($providers);
        return array_merge(array_slice($providers, $offset), array_slice($providers, 0, $offset));
    }
}
